package com.soo7ru.popularmoviesstage1.activity;
...
import com.soo7ru.popularmoviesstage1.R;
import com.soo7ru.popularmoviesstage1.adapter.CastAdapter;
import com.soo7ru.popularmoviesstage1.adapter.ReviewAdapter;
import com.soo7ru.popularmoviesstage1.adapter.TrailerAdapter;
import com.soo7ru.popularmoviesstage1.database.AppExecutors;
import com.soo7ru.popularmoviesstage1.database.MovieDatabase;
import com.soo7ru.popularmoviesstage1.model.Movie;
import com.soo7ru.popularmoviesstage1.model.MovieCast;
import com.soo7ru.popularmoviesstage1.model.MovieCreditResponse;
import com.soo7ru.popularmoviesstage1.model.MovieReview;
import com.soo7ru.popularmoviesstage1.model.MovieReviewResponse;
import com.soo7ru.popularmoviesstage1.model.MovieTrailer;
import com.soo7ru.popularmoviesstage1.model.MovieTrailerResponse;
import com.soo7ru.popularmoviesstage1.networking.RESTClient;
import com.soo7ru.popularmoviesstage1.networking.RESTClientInterface;
import com.soo7ru.popularmoviesstage1.utilities.Constants;
import com.soo7ru.popularmoviesstage1.utilities.DateUtil;
import com.soo7ru.popularmoviesstage1.utilities.MovieUtils;
                ...
                public void onResponse(@NonNull Call<MovieCreditResponse> call,
                    ...
                    if (statusCode == 200) {
                        if (response.body() != null) {
                            ...
                            List<MovieCast> casts = movieCreditResponse.getCast();
                ...
                public void onResponse(@NonNull Call<MovieTrailerResponse> call,
                    ...
                    if (statusCode == 200) {
                        if (response.body() != null) {
                            ...
                            List<MovieTrailer> trailers = movieTrailerResponse.getTrailers();
                ...
                public void onResponse(@NonNull Call<MovieReviewResponse> call,
                    ...
                    if (statusCode == 200) {
                        if (response.body() != null) {
                            ...
                            List<MovieReview> reviews = movieReviewResponse.getReviews();
